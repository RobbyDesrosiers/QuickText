...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_selected_phone_number = QtWidgets.QLabel(self.centralwidget)
        ...
        self.btn_phone_numbers = VariableButton(self.centralwidget)
        ...
        self.menuFile.addAction(self.actionMessages)
